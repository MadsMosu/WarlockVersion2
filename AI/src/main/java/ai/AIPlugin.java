...
//    }
//
//    private Entity lowestDistance(Entity ai, Map<Entity, Float> map) {
//        AI aiComp = ai.get(AI.class);
...
//    }
//
//    private Entity lowestHealth(World world, Entity ai, Map<Entity, Double> map) {
//        AI aiComp = ai.get(AI.class);
...
//        aiComp.setSpellToAvoid(lowestDistance(ai, aiComp.getCloseSpells()));
//    }
//
...
//        aiComp.setCurrentTarget(lowestDistance(ai, aiComp.getAllEntities()));
//    }
//
...
//        } else {
//            newTarget = lowestHealth(world, ai, aiComp.getAllEntitiesHealth());
//        }
//
//    }
//
//    private void escapeLava(Entity ai) {
//
//    }
//
...
//                attack(ai, world);
//            } else {
//                chase(ai, lowestDistance(ai, aiComp.getAllEntities()));
//            }
